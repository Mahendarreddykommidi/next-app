...
export default function Navbar() {
  ...
  return (
    <nav className="navbar-section mx-auto text-black flex items-center  justify-between px-6 md:px-16  shadow-2xl py-4 dark:bg-pink-700 fixed w-full top-0 left-0  bg-white">
